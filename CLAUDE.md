...
**Status**: Active development (v0.9.x).
...
│       ├── stack_nav.rs      # Stack navigation helpers
...
│           ├── reconcile.rs  # Reconcile stack state
│           ├── reorder.rs    # Interactive reorder commits
│           ├── reorder_tui.rs # TUI for reorder
│           ├── restack.rs    # Restack commits
