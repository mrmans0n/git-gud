...
| --- | --- |
| Initialize, enter, or inspect a stack | [setup and inspection](references/setup-and-inspection.md) |
| Amend, absorb, split, reorder, unstack, drop, rebase, or restack | [editing stacks](references/editing-stacks.md) |
